...
public class ExoPlayerRecyclerView extends RecyclerView {
    ...
    private static final String AppName = "Demo App";
    ...
    // Media List
    private ArrayList<PojoUser> mediaObjects = new ArrayList<>();
    ...
    public void setMediaObjects(ArrayList<PojoUser> mediaObjects) {
